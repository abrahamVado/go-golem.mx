...
func RegisterRoutes(private *gin.RouterGroup, rbac *rbacmod.Service, h *Handler) {
	...
	private.PUT("/projects/:id", middleware.RequirePermission(rbac, "project:update"), h.UpdateProject)
	private.DELETE("/projects/:id", middleware.RequirePermission(rbac, "project:delete"), h.DeleteProject)
	private.GET("/projects/:id/members", middleware.RequirePermission(rbac, "project:view"), h.ListProjectMembers)
	private.PUT("/projects/:id/members", middleware.RequirePermission(rbac, "member:invite"), h.UpdateProjectMembers)
